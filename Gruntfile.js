                                    ...
                                    if (subviewsDefinition[key].isSubMenuTitle) {
                                        result += '\n<li id="'+subviewsDefinition[key].name+'" ng-show="showParentPortal(\'' + subviewsDefinition[key].name + '\')">'
                                            ...
                                            result = result + '\n</ul>';
                                                ...
                                                } else if(subviewsDefinition[key].name === "User Management") {
                                                    result += '\n<li ui-sref-active="active" ng-click="changeFavicon(\'user-management\')" ng-if="portalsAccessPermission[\'' + subviewsDefinition[key].nameForUrl + '\']">'
                                                        + '\n<a ui-sref="portal.subview' + cnt + '" uib-tooltip="{{\''+ subviewsDefinition[key].tooltip +'\' | translate}}"  tooltip-append-to-body="true" tooltip-placement="right"><img src="styles/patterns/user-management.png" style="height:20px;"> <span class="nav-label">{{\''+
                                                         subviewsDefinition[key].name+ '\' | translate}}</span> </a>\n</li>';
                                                } else {
