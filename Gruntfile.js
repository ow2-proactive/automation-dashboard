                ...
                options: {
                    patterns: [
                        ...
                        },
                        {
                            ...
                            replacement: function () {
                                var result = '';
                                result = '\n<li id="collapse-menu" style="margin-top:-4px;"> <a href="javascript:void(0)" ng-click ="collapseMenu()" style="background-color: #002d66; "><i class="fa fa-caret-left pull-right" style="font-size: x-large;margin-top:-4px;"></i></a></li>'
                                var cnt = 0;
                                for (var key in subviewsDefinition) {
                                    if (subviewsDefinition[key].isSubMenuTitle) {
